...
@section('content')
    {{-- HERO IMAGE --}}
    <section
        class="bg-center bg-no-repeat bg-[url('https://beorigen.com/wp-content/uploads/2023/08/taller-de-jabones.jpg')] bg-gray-700 bg-blend-multiply">
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div
            ...
            <div class="w-full lg:w-1/2 aspect-square bg-cover bg-center rounded-lg shadow-md"
                style="background-image: url('https://beorigen.com/wp-content/uploads/2023/08/taller-de-jabones.jpg');">
            </div>

            {{-- Text --}}
            <div
                class="w-full lg:w-1/2 aspect-square flex flex-col justify-center bg-white dark:bg-gray-900 rounded-lg shadow-md p-8">
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Nuestra Filosofía</h3>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="px-4 py-8 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <h2 class="mb-4 text-4xl font-extrabold text-center text-gray-900 dark:text-white">Sobre nosotros</h2>
            <p class="mb-8 text-lg font-normal text-center text-gray-500 lg:mb-16 sm:px-16 lg:px-48 dark:text-gray-400">En
                Bohême Nature realizamos todo el proceso de elaboración artesanalmente de principio a fin, con productos
                naturales y ecológicos. Nuestros jabones son elaborados con ingredientes de alta calidad y sin
                conservantes ni aditivos químicos, lo que los hace ideales para todo tipo de piel.</p>
        </div>
    </section>
@endsection
